    ...
    <form className="campaign-form scene-form" action={formAction} noValidate>
      ...
      <div className="form-columns">
        <div className="form-field">
          ...
          <input id="scene-title" name="title" type="text" defaultValue={scene?.title ?? ""} maxLength={160} required />
          <ErrorList errors={state.errors.title} />
        </div>
        <div className="form-field">
          <label htmlFor="scene-location">{copy.locationLabel}</label>
          <select id="scene-location" name="locationId" defaultValue={scene?.locationId ?? ""}>
      ...
      <div className="form-field">
        ...
        <textarea id="scene-expected" name="expectedSetup" defaultValue={scene?.expectedSetup ?? ""} rows={5} maxLength={2_000} required />
        <ErrorList errors={state.errors.expectedSetup} />
      </div>
      <div className="form-field">
        <label htmlFor="scene-actual">{copy.actualSetupLabel}</label>
        <textarea id="scene-actual" name="actualSetup" defaultValue={scene?.actualSetup ?? ""} rows={5} maxLength={2_000} required />
      ...
      <div className="form-field">
        ...
        <input id="scene-objective" name="objective" type="text" defaultValue={scene?.objective ?? ""} maxLength={500} />
      ...
      <SelectionFieldset
        ...
        selectedIds={scene?.participantCharacterIds ?? []}
      />
      <SelectionFieldset
        ...
        selectedIds={scene?.participantEntityIds ?? []}
      />
      <SelectionFieldset
        ...
        selectedIds={scene?.relevantThreadIds ?? []}
      />
