...
Spielleiter, Szenendialog, vollständiges Journal, Notiz, Probe, Orakel, Inspiration, Ereignis und Szenenabschluss bilden eine gemeinsame zugängliche Tab-Reihe. Der Szenenrahmen bleibt platzsparend aufklappbar. Auf großen Bildschirmen füllt der aktive Arbeitsbereich den verbleibenden Platz und scrollt intern; auf schmalen Bildschirmen bleibt die Tab-Reihe horizontal erreichbar. Spieler-, Erzähler- und freie Journaltexte können auch nachträglich bearbeitet werden. Jede Bearbeitung erzeugt atomar ein eigenes Kampagnenereignis; Würfel- und Orakelergebnisse bleiben unveränderlich.
